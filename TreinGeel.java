...
/**
 * Write a description of class TreinGeel here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class TreinGeel extends Treinen
{
    /**
     * Act - do whatever the TreinGeel wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if (isTouching(ContainerGeelDek3.class) || isTouching (ContainerGeelDek2.class) || isTouching(ContainerGeelDek1.class)){
            //int x = getX();
            //  int y = getY();
            //int ny = getY()+1;
            setLocation (x, ny);
